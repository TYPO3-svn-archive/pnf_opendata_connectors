...
/**
 * @file class.tx_pnfcmdapittnews_tt_news_cat_datasource.php
 *
 ...
 */
class tx_pnfcmdapittnews_tt_news_cat_datasource
{
	// *************************
	// * User inclusions 0
	 ...
	 * @return	array	Array of records
	 */
	public function getTtnewscatsAll($params)
	{
		// *************************
		...
		$queryarray = array();
		$queryarray['fields'] = 
			'`tt_news_cat`.`uid` AS `id`, ' . 
			'`tt_news_cat`.`title` AS `title`, ' . 
			'`tt_news_cat`.`parent_category` AS `parent`, ' . 
			'`tt_news_cat`.`description` AS `description`';
		$queryarray['fromtable'] = 
			'`tt_news_cat`';
		$queryarray['where'] = 
			'1' . t3lib_BEfunc::deleteClause('tt_news_cat') . t3lib_BEfunc::BEenableFields('tt_news_cat');
		$queryarray['groupby'] = 
			'';
		$queryarray['order'] = 
			'';
...
} // End of class tx_pnfcmdapittnews_tt_news_cat_datasource

if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pnf_cmdapi_ttnews/opendata/datasource/class.tx_pnfcmdapittnews_tt_news_cat_datasource.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pnf_cmdapi_ttnews/opendata/datasource/class.tx_pnfcmdapittnews_tt_news_cat_datasource.php']);
}
?>